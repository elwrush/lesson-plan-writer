...
description: Publishes a reveal.js slide site generated by json_to_markdown to GitHub Pages. Pushes the slides directory to the gh-pages branch and returns the live URL.
---
...
- `slides/` directory must exist with `index.html`

## Workflow

### Step 1: Verify inputs
- Check that `slides/` directory exists with `index.html`
...
# Copy slides contents to root
Copy-Item -Recurse -Force "output/{subfolder}/slides/*" .
...
Copy-Item -Recurse -Force "output/{subfolder}/slides/*" {presentation}/
git add -A
