...
function Div(d)
  if d.classes:includes('shield') then
    d.attributes['style'] = 'display: flex; align-items: center; width: fit-content; margin: 0.6em auto; padding: 0.1em 0.4em; background: rgba(0, 0, 0, 0.55); border-radius: 4px; text-shadow: none; line-height: 1.3;'
